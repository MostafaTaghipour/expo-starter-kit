...
export default class ToastView extends Component {
  ...
  render() {
    ...
    if (this.props.position > 0) {
      ...
      containerStyle.top = 16 + getStatusBarHeight();
      ...
      containerStyle.top = 0;
      containerStyle.bottom = 16 + (isIphoneX() ? iosBottomXHeight : 0);
    ...
    return (
      <View style={[styles.container, containerStyle]} pointerEvents="none">
        <Animated.View style={[styles.content, contentStyle, this.props.style]}>
          {this.props.icon}
          {this.props.text ? (
