...
export const isIphoneX = () => {
  if (Platform.OS === "ios") {
    if (
      (screenH === IPHONEX_HEIGHT && screenW === IPHONEX_WIDTH) ||
      (screenH === IPHONEX_WIDTH && screenW === IPHONEX_HEIGHT) ||
      (screenH === IPHONEX_MAX_HEIGHT && screenW === IPHONEX_MAX_WIDTH) ||
      (screenH === IPHONEX_MAX_WIDTH && screenW === IPHONEX_MAX_HEIGHT)
    ) {
      return true;
    }
  }
